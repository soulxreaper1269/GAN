...
Original file is located at
    https://colab.research.google.com/drive/1vouPuAYpVkc1Yo4y-ptPNkSMLGJHFRRw
...
![](https://pbs.twimg.com/media/Dw6ZIOlX4AMKL9J.jpg:large)
...
![](https://raw.githubusercontent.com/carpedm20/DCGAN-tensorflow/master/DCGAN.png)
"""
...
checkpoint_dir = r'C:\Users\abhiu\Desktop\college stuff\sem 6\Deep Learning\gan\weights'
...
def generate_and_save_images(model, epoch, test_input):
  ...
  plt.savefig(r'C:\Users\abhiu\Desktop\college stuff\sem 6\Deep Learning\gan_images\image_at_epoch_{:04d}.png'.format(epoch))
  plt.show()
